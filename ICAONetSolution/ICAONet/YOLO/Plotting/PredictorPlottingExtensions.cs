...
public static class PredictorPlottingExtensions
{
                                                                       ...
                                                                       DetectionPlottingOptions? options = null)
    {
        ...
        configuration = configuration ?? new YoloConfiguration();
        configuration.Confidence = confidence;
    ...
    public static async Task<YoloResult<Detection>> DetectAsync(this YoloPredictor predictor,
                                                                       byte[] byteArrayImage,
                                                                       float confidence,
                                                                       string? output = null,
                                                                       YoloConfiguration? configuration = null,
                                                                       DetectionPlottingOptions? options = null)
    {
        using var image = Image.Load(byteArrayImage);
    ...
    public static async Task<YoloResult> PredictAndSaveAsync(this YoloPredictor predictor, string path, float confidence, string? output = null, YoloConfiguration? configuration = null, PlottingOptions? options = null)
    {
        return predictor.Metadata.Task switch
        {
            YoloTask.Pose => await PoseAndSaveAsync(predictor, path, output, configuration, options as PosePlottingOptions),
            YoloTask.Detect => await DetectAndSaveAsync(predictor, path, confidence, output, configuration, options as DetectionPlottingOptions),
    ...
    public static async Task<YoloResult> PredictAsync(this YoloPredictor predictor, byte[] image, float confidence, string? output = null, YoloConfiguration? configuration = null, PlottingOptions? options = null)
    {
        return predictor.Metadata.Task switch
        {
            //YoloTask.Pose => await PoseAndSaveAsync(predictor, path, output, configuration, options as PosePlottingOptions),
            YoloTask.Detect => await DetectAsync(predictor, image, confidence, output, configuration, options as DetectionPlottingOptions),
            //YoloTask.Obb => await DetectObbAndSaveAsync(predictor, path, output, configuration, options as DetectionPlottingOptions),
            //YoloTask.Segment => await SegmentAndSaveAsync(predictor, path, output, configuration, options as SegmentationPlottingOptions),
            //YoloTask.Classify => await ClassifyAndSaveAsync(predictor, path, output, configuration, options as ClassificationPlottingOptions),
            _ => throw new NotSupportedException("Unsupported YOLO task")
